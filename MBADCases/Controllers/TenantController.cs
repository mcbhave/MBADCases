...
namespace MBADCases.Controllers
{
    ...
    public class TenantController : ControllerBase
    {
        ...
        //public TenantController(CaseService caseservice)
        //{
        ...
        //    {
        //        Case ocase = _caseservice.Get(id);
        //        oms = _caseservice.SetMessage(ICaseTypes.TENANT, id, id, "GET", "200", "Case Searched", usrid, null);
        //        ocase.Message = new ReturnMessage { Messagecode = oms.Messagecode, MessageDesc = oms.MessageDesc, Messageype = oms.Messageype, _id = oms._id };
        ...
        //    {
        //        Case ocase = new Case();
        //        oms = _caseservice.SetMessage(ICaseTypes.TENANT , id, id, "GET", "", "", usrid, ex);
        //        ocase.Message = new ReturnMessage { Messagecode = oms.Messagecode, MessageDesc = oms.MessageDesc, Messageype = oms.Messageype, _id = oms._id };
        ...
        //        oms = _caseservice.SetMessage(ICaseTypes.TENANT, value._id, sj, "POST", "UPDATE", "Case update", usrid, null);
        ...
        //        oms = _caseservice.SetMessage(ICaseTypes.TENANT, id, sj, "POST", "UPDATE", "Case update", usrid, ex);
        //        ocase.Message = new ReturnMessage { Messagecode = oms.Messagecode, MessageDesc = oms.MessageDesc, Messageype = oms.Messageype, _id = oms._id };
        //        return StatusCode(Microsoft.AspNetCore.Http.StatusCodes.Status417ExpectationFailed, ocase);
        //    }
        ...
        //        oms = _caseservice.SetMessage(ICaseTypes.TENANT, id, sj, "PUT", "200", "Case insert", usrid, null);
        //        ocase.Message = new ReturnMessage { Messagecode = oms.Messagecode, MessageDesc = oms.MessageDesc, Messageype = oms.Messageype, _id = oms._id };
        //        return CreatedAtRoute("GetTenant", new { id = ocase._id.ToString() }, ocase);
        //    }
        //    catch (Exception ex)
        //    {
        //        oms = _caseservice.SetMessage(ICaseTypes.TENANT, id, sj, "PUT", "", "Case insert", usrid, ex);
        //        ocase.Message = new ReturnMessage { Messagecode = oms.Messagecode, MessageDesc = oms.MessageDesc, Messageype = oms.Messageype, _id = oms._id };
        //        return StatusCode(Microsoft.AspNetCore.Http.StatusCodes.Status417ExpectationFailed, ocase);
        ...
        //        oms = _caseservice.SetMessage(ICaseTypes.TENANT, id, id, "DELETE", "200", "Case delete", usrid, null);
        //        ocase.Message = new ReturnMessage { Messagecode = oms.Messagecode, MessageDesc = oms.MessageDesc, Messageype = oms.Messageype, _id = oms._id };
        //        return StatusCode(Microsoft.AspNetCore.Http.StatusCodes.Status417ExpectationFailed, ocase);
        //    }
        //    catch (Exception ex)
        //    {
        //        oms = _caseservice.SetMessage(ICaseTypes.TENANT, id, id, "DELETE", "200", "Case delete", usrid, ex);
        //        ocase.Message = new ReturnMessage { Messagecode = oms.Messagecode, MessageDesc = oms.MessageDesc, Messageype = oms.Messageype, _id = oms._id };
        //        return StatusCode(Microsoft.AspNetCore.Http.StatusCodes.Status417ExpectationFailed, ocase);
